        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form:form class="form-horizontal form-label-left" novalidate="" action="${pageContext.request.contextPath}/country/store"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <form:select path="directorId" class="form-control col-md-7 col-xs-12" >
<%--                                    <form:options  items="${directors}" itemValue="directorId" itemLabel="name" ></form:options>--%>
...
<%--                                </select>--%>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <form:select path="playerId" multiple="multiple" class="select2_multiple form-control col-md-7 col-xs-12">
<%--                                    <form:options items="${players}" itemLabel="palyerName" itemValue="playerId" ></form:options>--%>
                                    <c:forEach items="${players}" var="player">
                                        <option value="${player.id}">${player.name}</option>
                                    </c:forEach>
                                </form:select>

<%--                                <select name="playerId" multiple="multiple" class="select2_multiple form-control col-md-7 col-xs-12">--%>
<%--                                    <c:forEach items="${players}" var="player">--%>
<%--                                        <option value="${player.id}">${player.name}</option>--%>
<%--                                    </c:forEach>--%>
<%--                                </select>--%>
